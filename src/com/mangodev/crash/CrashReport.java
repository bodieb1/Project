...
public class CrashReport
{
    ...
    private final CrashReportCategory reportCategory = new CrashReportCategory(this, "Calling Method Details");
    ...
    private void populateEnvironment()
    {
		...
		this.reportCategory.addCrashSection("Line Number", callersLineNumber);
		this.reportCategory.addCrashSection("Calling Method", methodName);
		this.reportCategory.addCrashSection("Calling Class", className);
        this.theReportCategory.func_189529_a("Software Version", new ICrashReportDetail<String>()
        {
            public String call()
            {
                return "PRE_ALPHA 1.0";
            }
        });
    ...
    public void getSectionsInStringBuilder(StringBuilder builder)
    {
        ...
        this.reportCategory.appendToStringBuilder(builder);
    }
	...
	public boolean saveToFile(File toFile)
    {
        ...
        else
        {
            ...
            {
                Log.logError("Could not save crash report to file.");
                flag1 = false;
            }
            finally
            {
